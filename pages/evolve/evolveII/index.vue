<template>
    ...
    <h1 class="section-header white" style="padding:2rem 0 1rem" >  EVOLVE &nbsp;- &nbsp; Level II</h1>
<b-row class="">
<b-col lg="8">
  <b-row>
    <b-col lg="5">
...
EVOLVE-II is created for marketers by marketers. In a rapidly changing communications industry, EVOLVE aims to work with limited batches and grow your understanding about the future of marketing. Whether you come from Advertising, Digital Marketing, Public Relations or social media marketing, EVOLVE will add value to your personal marketing journey.<br>
